        ...
        <div className="rounded-[10px] border border-[#E7E7E7] bg-white">
            <div className="p-[11px]">
                ...
                <div className="mt-6 mb-2">
                    <h2 className="text-xs lg:text-sm font-medium text-[#152A16]">{name}</h2>
                </div>
                <p className="flex gap-1 items-center mt-[15px] mb-3 text-[11px] text-[#5C635A] lg:text-sm"><svg xmlns="http://www.w3.org/2000/svg" width="14" height="14" viewBox="0 0 14 14" fill="none">
                ...
                <p className="flex text-[11px] items-center mb-2 lg:text-sm gap-2 text-[#5C635A]"><img src={car} alt="" />Mobile & In-Studio</p>
            </div>
