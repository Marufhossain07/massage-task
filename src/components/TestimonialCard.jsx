...
const TestimonialCard = ({therapist}) => {
    return (
        <div className="flex p-[10px] w-[490px] gap-[10px] rounded-xl overflow-hidden border border-[#E7E7E7] ">
                ...
                <div>
                <p className="flex gap-1 items-center text-[#5C635A] text-sm"><svg xmlns="http://www.w3.org/2000/svg" width="14" height="14" viewBox="0 0 14 14" fill="none">
                    ...
                    <h3 className="text-sm text-[#232F3C] pt-[15px] font-medium">Healing Bodywork <span className="text-[#156BCA] italic font-semibold">by {therapist?.name}</span></h3>
                    <p className="text-[#5C635A] py-3 text-[13px]">{therapist?.name}&apos;s healing bodywork massage was <br /> absolutely transformative. Their intuitive touch <br /> and deep understanding of<span className="text-[#156BCA] font-medium">...Read More</span></p>
                </div>
            </div>
    );
};
