            ...
            <div className="flex pt-24 justify-between items-center w-full mx-auto overflow-hidden bg-white rounded-lg">
                <div className=" text-left">
                    ...
                    <div className="flex gap-12 justify-between mt-10">
                        <button style={{ background: 'linear-gradient(91deg, #E4E4E4 0.64%, #FFFFFF 99.53%)', boxShadow: '0px 4px 7px 0px rgba(131, 131, 131, 0.23)' }} className="flex gap-3 justify-center border rounded-md items-center py-4 px-10 font-pop text-[#152A16]">
